...
int temp;
int M_X_MIN  = EEPROM.get(0, temp);
int M_Y_MIN  = EEPROM.get(2, temp);
int M_Z_MIN  = EEPROM.get(4, temp);
int M_X_MAX  = EEPROM.get(6, temp);
int M_Y_MAX  = EEPROM.get(8, temp);
int M_Z_MAX  = EEPROM.get(10, temp);
